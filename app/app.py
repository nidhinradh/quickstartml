...
class App:
    ...
    def __init__(self):
        ...
        self.sidebar_template_menu_subheading = os.environ.get("SIDEBAR_TEMPLATE_MENU_SUBHEADING")
        self.sidebar_template_menu_selectbox_label = os.environ.get("SIDEBAR_TEMPLATE_MENU_SELECTBOX_LABEL")
        self.sidebar_framework_menu_selectbox_lebel = os.environ.get("SIDEBAR_FRAMEWORK_MENU_SELECTBOX_LABEL")
        self.configs = {}
        self.code_dir_path = ""
    ...
    def load_sidebar(self):
        with st.sidebar:
            ...
            self.selected_model_type = st.selectbox(self.sidebar_template_menu_selectbox_label, set(self.enabled_templates))
            selected_template_path = os.path.join(self.templates_base_dir, self.selected_model_type)
